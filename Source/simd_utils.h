...
namespace utils
{
    ...
    force_inline simd_float centsToRatio(simd_float value)
    { return map<centsToRatio>(value); }

    force_inline simd_float noteOffsetToRatio(simd_float value)
    { return map<centsToRatio>(value); }

    force_inline simd_float midiCentsToFrequency(simd_float value)
    { return map<midiCentsToFrequency>(value); }

    force_inline simd_float midiNoteToFrequency(simd_float value)
    { return map<midiNoteToFrequency>(value); }

    force_inline simd_float frequencyToMidiNote(simd_float value)
    { return map<frequencyToMidiNote>(value); }

    force_inline simd_float frequencyToMidiCents(simd_float value)
    { return map<frequencyToMidiCents>(value); }

    force_inline simd_float magnitudeToDb(simd_float value) { return map<magnitudeToDb>(value); }
    force_inline simd_float dbToMagnitude(simd_float value) { return map<dbToMagnitude>(value); }
