...
static inline NVGcolor nvgTransRGBA(NVGcolor c, unsigned char a)
{
  c.a = a / 255.0f;
  return c;
}
...
// Sets transparency of a color value.
static inline NVGcolor nvgTransRGBAf(NVGcolor c, float a)
{
  c.a = a;
  return c;
}
...
// Get font face id of current text style.
