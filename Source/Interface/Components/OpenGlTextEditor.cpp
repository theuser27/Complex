/*
  ==============================================================================
    ...
    OpenGlTextEditor.cpp
    Created: 15 Dec 2023 9:18:29pm
    Author:  theuser27
...
namespace Interface
{
  ...
  class OpenGlTextEditor::UniformTextSection
  {
  public:
  ...
  //==============================================================================
  struct OpenGlTextEditor::Iterator
  {
    Iterator(const OpenGlTextEditor &ed)
  ...
  //==============================================================================
  struct OpenGlTextEditor::InsertAction : public UndoableAction
  {
    InsertAction(OpenGlTextEditor &ed, const String &newText, int insertPos,
  ...
  //==============================================================================
  struct OpenGlTextEditor::RemoveAction : public UndoableAction
  {
    RemoveAction(OpenGlTextEditor &ed, Range<int> rangeToRemove, int oldCaret, int newCaret,
  ...
  //==============================================================================
  struct OpenGlTextEditor::TextHolderComponent : public Component,
    public Timer,
    public Value::Listener
  {
    TextHolderComponent(OpenGlTextEditor &ed) : owner(ed)
    {
  ...
  //==============================================================================
  struct OpenGlTextEditor::TextEditorViewport : public Viewport
  {
    TextEditorViewport(OpenGlTextEditor &ed) : owner(ed) { }
  ...
  //==============================================================================
  OpenGlTextEditor::OpenGlTextEditor(const String &name, juce_wchar passwordChar) : BaseComponent(name),
    passwordCharacter(passwordChar), usedFont_(Fonts::instance()->getInterVFont())
  {
    ...
    imageComponent_->setPaintFunction([this](Graphics &g) { paintEntireComponent(g, false); });
  }
  ...
  //==============================================================================
  void OpenGlTextEditor::newTransaction()
  {
    lastTransactionTime = Time::getApproximateMillisecondCounter();
    undoManager.beginNewTransaction();
  }

  bool OpenGlTextEditor::undoOrRedo(const bool shouldUndo)
  {
    if (!isReadOnly())
    {
      newTransaction();
  ...
  bool OpenGlTextEditor::undo() { return undoOrRedo(true); }
  bool OpenGlTextEditor::redo() { return undoOrRedo(false); }

  //==============================================================================
  void OpenGlTextEditor::setMultiLine(const bool shouldBeMultiLine,
  ...
  bool OpenGlTextEditor::isMultiLine() const
  {
    return multiline;
  }

  void OpenGlTextEditor::setScrollbarsShown(bool shown)
  {
  ...
  void OpenGlTextEditor::setReadOnly(bool shouldBeReadOnly)
  {
  ...
  void OpenGlTextEditor::setClicksOutsideDismissVirtualKeyboard(bool newValue)
  {
    clicksOutsideDismissVirtualKeyboard = newValue;
  }

  bool OpenGlTextEditor::isReadOnly() const noexcept
  {
    return readOnly || !isEnabled();
  }

  bool OpenGlTextEditor::isTextInputActive() const
  {
    return !isReadOnly() && (!clicksOutsideDismissVirtualKeyboard || globalMouseListener.lastMouseDownInEditor());
  }

  void OpenGlTextEditor::setReturnKeyStartsNewLine(bool shouldStartNewLine)
  {
    returnKeyStartsNewLine = shouldStartNewLine;
  }

  void OpenGlTextEditor::setTabKeyUsedAsCharacter(bool shouldTabKeyBeUsed)
  {
    tabKeyUsed = shouldTabKeyBeUsed;
  }

  void OpenGlTextEditor::setPopupMenuEnabled(bool b)
  {
    popupMenuEnabled = b;
  }

  void OpenGlTextEditor::setSelectAllWhenFocused(bool b)
  {
    selectAllTextWhenFocused = b;
  }

  void OpenGlTextEditor::setJustification(Justification j)
  {
    if (justification != j)
    {
      justification = j;
  ...
  //==============================================================================
  void OpenGlTextEditor::setFont(const Font &newFont)
  {
    currentFont = newFont;
    scrollToMakeSureCursorIsVisible();
  }

  void OpenGlTextEditor::applyFontToAllText(const Font &newFont, bool changeCurrentFont)
  {
  ...
  void OpenGlTextEditor::applyColourToAllText(const Colour &newColour, bool changeCurrentTextColour)
  {
    for (auto *uts : sections)
      uts->colour = newColour;

    if (changeCurrentTextColour)
      setColour(OpenGlTextEditor::textColourId, newColour);
    else
      repaint();
  }

  void OpenGlTextEditor::lookAndFeelChanged()
  {
    caret.reset();
    recreateCaret();
    repaint();
  ...
  void OpenGlTextEditor::parentHierarchyChanged()
  {
    BaseComponent::parentHierarchyChanged();
    lookAndFeelChanged();
  }

  void OpenGlTextEditor::enablementChanged()
  {
    recreateCaret();
    repaint();
  }

  void OpenGlTextEditor::setCaretVisible(bool shouldCaretBeVisible)
  {
  ...
  void OpenGlTextEditor::recreateCaret()
  {
    if (isCaretVisible())
    {
      if (caret == nullptr)
  ...
  void OpenGlTextEditor::updateCaretPosition()
  {
    if (caret != nullptr
  ...
  OpenGlTextEditor::LengthAndCharacterRestriction::LengthAndCharacterRestriction(int maxLen, const String &chars)
    : allowedCharacters(chars), maxLength(maxLen)
  {
  }

  String OpenGlTextEditor::LengthAndCharacterRestriction::filterNewText(OpenGlTextEditor &ed, const String &newInput)
  {
    String t(newInput);
  ...
  void OpenGlTextEditor::setInputFilter(InputFilter *newFilter, bool takeOwnership)
  {
    inputFilter.set(newFilter, takeOwnership);
  }

  void OpenGlTextEditor::setInputRestrictions(int maxLen, const String &chars)
  {
    setInputFilter(new LengthAndCharacterRestriction(maxLen, chars), true);
  }

  void OpenGlTextEditor::setTextToShowWhenEmpty(const String &text, Colour colourToUse)
  {
    textToShowWhenEmpty = text;
    colourForTextWhenEmpty = colourToUse;
  }

  void OpenGlTextEditor::setPasswordCharacter(juce_wchar newPasswordCharacter)
  {
  ...
  void OpenGlTextEditor::setScrollBarThickness(int newThicknessPixels)
  {
    viewport->setScrollBarThickness(newThicknessPixels);
  }

  //==============================================================================
  void OpenGlTextEditor::clear()
  {
  ...
  void OpenGlTextEditor::setText(const String &newText, bool sendTextChangeMessage)
  {
  ...
  //==============================================================================
  void OpenGlTextEditor::updateValueFromText()
  {
  ...
  Value &OpenGlTextEditor::getTextValue()
  {
    updateValueFromText();
    return textValue;
  }

  void OpenGlTextEditor::textWasChangedByValue()
  {
  ...
  //==============================================================================
  void OpenGlTextEditor::textChanged()
  {
    checkLayout();
  ...
  void OpenGlTextEditor::setSelection(Range<int> newSelection) noexcept
  {
  ...
  void OpenGlTextEditor::returnPressed() { postCommandMessage(TextEditorDefs::returnKeyMessageId); }
  void OpenGlTextEditor::escapePressed() { postCommandMessage(TextEditorDefs::escapeKeyMessageId); }

  void OpenGlTextEditor::addListener(OpenGlTextEditorListener *l) { listeners.add(l); }
  void OpenGlTextEditor::removeListener(OpenGlTextEditorListener *l) { listeners.remove(l); }

  //==============================================================================
  void OpenGlTextEditor::timerCallbackInt()
  {
    checkFocus();
  ...
  void OpenGlTextEditor::checkFocus()
  {
    if (!wasFocused && hasKeyboardFocus(false) && !isCurrentlyBlockedByAnotherModalComponent())
      wasFocused = true;
  }

  void OpenGlTextEditor::repaintText(Range<int> range)
  {
    if (!range.isEmpty())
    {
  ...
  //==============================================================================
  void OpenGlTextEditor::moveCaret(const int newCaretPos)
  {
  ...
  int OpenGlTextEditor::getCaretPosition() const
  {
    return caretPosition;
  }

  void OpenGlTextEditor::setCaretPosition(const int newIndex)
  {
    moveCaretTo(newIndex, false);
  }

  void OpenGlTextEditor::moveCaretToEnd()
  {
    setCaretPosition(std::numeric_limits<int>::max());
  }

  void OpenGlTextEditor::scrollEditorToPositionCaret(const int desiredCaretX,
  ...
  Rectangle<int> OpenGlTextEditor::getCaretRectangleForCharIndex(int index) const
  {
    Point<float> anchor;
  ...
  Point<int> OpenGlTextEditor::getTextOffset() const noexcept
  {
    Iterator i(*this);
  ...
  RectangleList<int> OpenGlTextEditor::getTextBounds(Range<int> textRange) const
  {
  ...
  int OpenGlTextEditor::getWordWrapWidth() const
  {
    return wordWrap ? getMaximumTextWidth()
      : std::numeric_limits<int>::max();
  }

  int OpenGlTextEditor::getMaximumTextWidth() const
  {
    return jmax(1, viewport->getMaximumVisibleWidth() - leftIndent - rightEdgeSpace);
  }

  int OpenGlTextEditor::getMaximumTextHeight() const
  {
    return jmax(1, viewport->getMaximumVisibleHeight() - topIndent);
  }

  void OpenGlTextEditor::checkLayout()
  {
  ...
  int OpenGlTextEditor::getTextWidth() const { return textHolder->getWidth(); }
  int OpenGlTextEditor::getTextHeight() const { return textHolder->getHeight(); }

  void OpenGlTextEditor::setIndents(int newLeftIndent, int newTopIndent)
  {
  ...
  void OpenGlTextEditor::setBorder(BorderSize<int> border)
  {
    borderSize = border;
    resized();
  }

  BorderSize<int> OpenGlTextEditor::getBorder() const
  {
    return borderSize;
  }

  void OpenGlTextEditor::setScrollToShowCursor(const bool shouldScrollToShowCursor)
  {
    keepCaretOnScreen = shouldScrollToShowCursor;
  }

  void OpenGlTextEditor::scrollToMakeSureCursorIsVisible()
  {
    updateCaretPosition();
  ...
  void OpenGlTextEditor::moveCaretTo(const int newPosition, const bool isSelecting)
  {
    if (isSelecting)
    {
  ...
  int OpenGlTextEditor::getTextIndexAt(const int x, const int y) const
  {
  ...
  int OpenGlTextEditor::getTextIndexAt(const Point<int> pt) const
  {
    return getTextIndexAt(pt.x, pt.y);
  }

  int OpenGlTextEditor::getCharIndexForPoint(const Point<int> point) const
  {
    return getTextIndexAt(isMultiLine() ? point : getTextBounds({ 0, getTotalNumChars() }).getBounds().getConstrainedPoint(point));
  }

  void OpenGlTextEditor::insertTextAtCaret(const String &t)
  {
  ...
  void OpenGlTextEditor::setHighlightedRegion(const Range<int> &newSelection)
  {
  ...
  //==============================================================================
  void OpenGlTextEditor::drawContent(Graphics &g)
  {
    if (getWordWrapWidth() > 0)
    {
  ...
  void OpenGlTextEditor::paint(Graphics &)
  {
  }

  void OpenGlTextEditor::paintOverChildren(Graphics &g)
  {
  ...
  //==============================================================================
  void OpenGlTextEditor::addPopupMenuItems(PopupMenu &m, const MouseEvent *)
  {
  ...
  void OpenGlTextEditor::performPopupMenuAction(const int menuItemID)
  {
    switch (menuItemID)
    {
    ...
    if (wasFocused || !selectAllTextWhenFocused)
    {
      ...
      else
      {
        ...
        m.showMenuAsync(PopupMenu::Options(),
          [safeThis = SafePointer<OpenGlTextEditor>{ this }](int menuResult)
        {
  ...
  //==============================================================================
  bool OpenGlTextEditor::moveCaretWithTransaction(const int newPos, const bool selecting)
  {
    newTransaction();
  ...
  bool OpenGlTextEditor::moveCaretLeft(bool moveInWholeWordSteps, bool selecting)
  {
  ...
  bool OpenGlTextEditor::moveCaretRight(bool moveInWholeWordSteps, bool selecting)
  {
    auto pos = getCaretPosition();
  ...
  bool OpenGlTextEditor::moveCaretUp(bool selecting)
  {
    if (!isMultiLine())
  ...
  bool OpenGlTextEditor::moveCaretDown(bool selecting)
  {
    if (!isMultiLine())
  ...
  bool OpenGlTextEditor::pageUp(bool selecting)
  {
    if (!isMultiLine())
      return moveCaretToStartOfLine(selecting);
  ...
  bool OpenGlTextEditor::pageDown(bool selecting)
  {
    if (!isMultiLine())
      return moveCaretToEndOfLine(selecting);
  ...
  void OpenGlTextEditor::scrollByLines(int deltaLines)
  {
    viewport->getVerticalScrollBar().moveScrollbarInSteps(deltaLines);
  }

  bool OpenGlTextEditor::scrollDown()
  {
    scrollByLines(-1);
    return true;
  }

  bool OpenGlTextEditor::scrollUp()
  {
    scrollByLines(1);
    return true;
  }

  bool OpenGlTextEditor::moveCaretToTop(bool selecting)
  {
    return moveCaretWithTransaction(0, selecting);
  }

  bool OpenGlTextEditor::moveCaretToStartOfLine(bool selecting)
  {
    const auto caretPos = (getCaretRectangle() - getTextOffset()).toFloat();
    return moveCaretWithTransaction(indexAtPosition(0.0f, caretPos.getY()), selecting);
  }

  bool OpenGlTextEditor::moveCaretToEnd(bool selecting)
  {
    return moveCaretWithTransaction(getTotalNumChars(), selecting);
  }

  bool OpenGlTextEditor::moveCaretToEndOfLine(bool selecting)
  {
    const auto caretPos = (getCaretRectangle() - getTextOffset()).toFloat();
    return moveCaretWithTransaction(indexAtPosition((float)textHolder->getWidth(), caretPos.getY()), selecting);
  }

  bool OpenGlTextEditor::deleteBackwards(bool moveInWholeWordSteps)
  {
    if (moveInWholeWordSteps)
  ...
  bool OpenGlTextEditor::deleteForwards(bool /*moveInWholeWordSteps*/)
  {
  ...
  bool OpenGlTextEditor::copyToClipboard()
  {
    newTransaction();
    copy();
    return true;
  ...
  bool OpenGlTextEditor::cutToClipboard()
  {
    newTransaction();
    copy();
    cut();
  ...
  bool OpenGlTextEditor::pasteFromClipboard()
  {
    newTransaction();
    paste();
    return true;
  ...
  bool OpenGlTextEditor::selectAll()
  {
    newTransaction();
  ...
  //==============================================================================
  void OpenGlTextEditor::setEscapeAndReturnKeysConsumed(bool shouldBeConsumed) noexcept
  {
  ...
  bool OpenGlTextEditor::keyPressed(const KeyPress &key)
  {
    ...
    if (!TextEditorKeyMapper<OpenGlTextEditor>::invokeKeyFunction(*this, key))
    {
  ...
  bool OpenGlTextEditor::keyStateChanged(const bool isKeyDown)
  {
    if (!isKeyDown)
      return false;
  ...
  //==============================================================================
  void OpenGlTextEditor::focusGained(FocusChangeType cause)
  {
    newTransaction();
  ...
  void OpenGlTextEditor::focusLost(FocusChangeType)
  {
    newTransaction();
  ...
  void OpenGlTextEditor::handleCommandMessage(const int commandId)
  {
    ...
    case TextEditorDefs::textChangeMessageId:
      listeners.callChecked(checker, [this](OpenGlTextEditorListener &l) { l.textEditorTextChanged(*this); });
    ...
    case TextEditorDefs::returnKeyMessageId:
      listeners.callChecked(checker, [this](OpenGlTextEditorListener &l) { l.textEditorReturnKeyPressed(*this); });
    ...
    case TextEditorDefs::escapeKeyMessageId:
      listeners.callChecked(checker, [this](OpenGlTextEditorListener &l) { l.textEditorEscapeKeyPressed(*this); });
    ...
    case TextEditorDefs::focusLossMessageId:
      updateValueFromText();
      listeners.callChecked(checker, [this](OpenGlTextEditorListener &l) { l.textEditorFocusLost(*this); });
  ...
  void OpenGlTextEditor::setTemporaryUnderlining(const Array<Range<int>> &newUnderlinedSections)
  {
    underlinedSections = newUnderlinedSections;
    repaint();
  }

  TextInputTarget::VirtualKeyboardType OpenGlTextEditor::getKeyboardType()
  {
    return passwordCharacter != 0 ? passwordKeyboard : keyboardType;
  }

  //==============================================================================
  UndoManager *OpenGlTextEditor::getUndoManager() noexcept
  {
    return readOnly ? nullptr : &undoManager;
  }

  void OpenGlTextEditor::clearInternal(UndoManager *const um)
  {
    remove({ 0, getTotalNumChars() }, um, caretPosition);
  }

  void OpenGlTextEditor::insert(const String &text, int insertIndex, const Font &font,
  ...
  void OpenGlTextEditor::reinsert(int insertIndex, const OwnedArray<UniformTextSection> &sectionsToInsert)
  {
    int index = 0;
    int nextIndex = 0;
  ...
  void OpenGlTextEditor::remove(Range<int> range, UndoManager *const um, const int caretPositionToMoveTo)
  {
    if (!range.isEmpty())
    {
      int index = 0;
  ...
  //==============================================================================
  String OpenGlTextEditor::getText() const
  {
  ...
  String OpenGlTextEditor::getTextInRange(const Range<int> &range) const
  {
    if (range.isEmpty())
      return {};
  ...
  String OpenGlTextEditor::getHighlightedText() const
  {
    return getTextInRange(selection);
  }

  int OpenGlTextEditor::getTotalNumChars() const
  {
    if (totalNumChars < 0)
    {
      totalNumChars = 0;
  ...
  bool OpenGlTextEditor::isEmpty() const
  {
    return getTotalNumChars() == 0;
  }

  void OpenGlTextEditor::getCharPosition(int index, Point<float> &anchor, float &lineHeight) const
  {
    if (getWordWrapWidth() <= 0)
    {
      anchor = {};
  ...
  int OpenGlTextEditor::indexAtPosition(const float x, const float y) const
  {
    if (getWordWrapWidth() > 0)
    {
  ...
  //==============================================================================
  int OpenGlTextEditor::findWordBreakAfter(const int position) const
  {
  ...
  int OpenGlTextEditor::findWordBreakBefore(const int position) const
  {
    if (position <= 0)
      return 0;
  ...
  //==============================================================================
  void OpenGlTextEditor::splitSection(const int sectionIndex, const int charToSplitAt)
  {
  ...
  void OpenGlTextEditor::coalesceSimilarSections()
  {
