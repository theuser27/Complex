...
namespace Interface
{
  ...
  struct TextEditor::Iterator
  {
    ...
    juce::Rectangle<int> getTextBounds(Range<int> range) const
    {
  ...
  //==============================================================================
  struct TextEditor::TextEditorViewport : public ::juce::Viewport
  {
  ...
  //==============================================================================
  TextEditor::TextEditor(const String &name, juce_wchar passwordChar) : BaseComponent{ name },
    passwordCharacter(passwordChar), usedFont_(Fonts::instance()->getInterVFont())
  {
    ...
    imageComponent_.setPaintFunction([this](Graphics &g, juce::Rectangle<int>) { paintEntireComponent(g, false); });
  }
  ...
  void TextEditor::addListener(OpenGlTextEditorListener *l) { listeners.add(l); }
  void TextEditor::removeListener(OpenGlTextEditorListener *l) { listeners.remove(l); }
  ...
  juce::Rectangle<int> TextEditor::getCaretRectangleForCharIndex(int index) const
  {
    Point<float> anchor;
  ...
  void TextEditor::paint(Graphics &)
  {
  }
