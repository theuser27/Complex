...
namespace Interface
{
  ...
  class OpenGlTextEditor : public BaseComponent, public TextInputTarget
  {
  public:
    //==============================================================================
    ...
    */
    explicit OpenGlTextEditor(const String &componentName = String(),
      juce_wchar passwordCharacter = 0);

    /** Destructor. */
    ~OpenGlTextEditor() override;
    ...
    */
    ...
    /** Changes the behaviour of the return key.
        ...
        it will trigger a call to the OpenGlTextEditor::Listener::textEditorReturnKeyPressed()
    ...
    */
    ...
    //==============================================================================
    /**
        Receives callbacks from a OpenGlTextEditor component when it changes.

        @see OpenGlTextEditor::addListener
    */
    ...
    /** Registers a listener to be told when things happen to the text.
        @see removeListener
    */
    void addListener(OpenGlTextEditorListener *newListener);

    /** Deregisters a listener.
        @see addListener
    */
    void removeListener(OpenGlTextEditorListener *listenerToRemove);
    ...
    */
    ...
    /** Sets the entire content of the editor.
        ...
        @code setColour (OpenGlTextEditor::textColourId, ...);
        @endcode
    ...
    */
    ...
    /** Returns the total width of the text, as it is currently laid-out.
        ...
        This may be larger than the size of the OpenGlTextEditor, and can change when
        the OpenGlTextEditor is resized or the text changes.
    */
    ...
    */
    ...
    /** Sets the line spacing of the OpenGlTextEditor.
    ...
    */
    ...
    /** Returns the current line spacing of the OpenGlTextEditor. */
    ...
    */
    ...
    //==============================================================================
    /** Base class for input filters that can be applied to a OpenGlTextEditor to restrict
    ...
    */
    ...
    public:
      ...
      */
      virtual String filterNewText(OpenGlTextEditor &, const String &newInput) = 0;
    };

    /** An input filter for a OpenGlTextEditor that limits the length of text and/or the
    ...
    */
    ...
    public:
      ...
      */
      ...
      String filterNewText(OpenGlTextEditor &, const String &) override;
    ...
    */
    ...
    /** Sets the behaviour of mouse/touch interactions outside this component.
        ...
        If true, then presses outside of the OpenGlTextEditor will dismiss the virtual keyboard.
        If false, then the virtual keyboard will remain onscreen for as long as the OpenGlTextEditor has
        keyboard focus.
    */
    ...
    */
    ...
    {
      BaseComponent::visibilityChanged();
  ...
  private:
    ...
    class GlobalMouseListener final : private MouseListener
    {
    public:
    ...
    ListenerList<OpenGlTextEditorListener> listeners;
