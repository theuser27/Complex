...
namespace Interface
{
	...
	{
	public:
		static bool setViewPort(const Component *component, Rectangle<int> bounds, OpenGlWrapper &openGl);
		static bool setViewPort(const Component *component, OpenGlWrapper &openGl);
		static void setScissor(const Component *component, OpenGlWrapper &openGl);
		static void setScissorBounds(const Component *component, Rectangle<int> bounds, OpenGlWrapper &openGl);
	...
	protected:
		bool setViewPort(OpenGlWrapper &openGl) const;
