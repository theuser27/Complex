...
namespace Interface
{
  class OpenGlViewport final : public BaseComponent, private juce::ComponentListener, private OpenGlScrollBarListener
  {
  public:
    //==============================================================================
    /** Creates a Viewport.
    ...
    */
    explicit OpenGlViewport(const juce::String &componentName = juce::String());
    ...
    */
    OpenGlScrollBar &getVerticalScrollBar() noexcept { return *verticalScrollBar; }

    /** Returns a reference to the scrollbar component being used.
        Handy if you need to customise the bar somehow.
    */
    OpenGlScrollBar &getHorizontalScrollBar() noexcept { return *horizontalScrollBar; }
    ...
    */
    ...
    /** @internal */
    void scrollBarMoved(OpenGlScrollBar *, double newRangeStart) override;
    /** @internal */
  ...
  private:
    std::unique_ptr<OpenGlScrollBar> verticalScrollBar, horizontalScrollBar;
