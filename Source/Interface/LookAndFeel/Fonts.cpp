...
namespace Interface
{
  ...
  void Fonts::setHeight(juce::Font &font, float height) const
  {
  ...
  void Fonts::setHeightFromAscent(juce::Font &font, float ascent) const
  { setHeight(font, getHeightFromAscent(font, ascent)); }
