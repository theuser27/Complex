...
namespace Framework
{
  ...
  inline constexpr std::array<std::string_view, 5> kPluginModules = 
  { "SoundEngine", "EffectsState", "EffectsChain", "EffectModule", "Effect" };
  ...
  { "Rectangle", "Hann", "Hamming", "Triangle", "Sine", "Exponential", "HannExponential", "Lanczos" };
  ...
  inline constexpr std::array <std::string_view, static_cast<size_t>(FilterTypes::Size)> kFilterTypeNames = { "Normal", "Regular" };

  inline constexpr std::array <std::string_view, static_cast<size_t>(ContrastTypes::Size)> kContrastTypeNames = { "Contrast" };
