...
#define COMPLEX_INTERNAL_REPEAT2(...) COMPLEX_INTERNAL_REPEAT1(COMPLEX_INTERNAL_REPEAT1(COMPLEX_INTERNAL_REPEAT1(COMPLEX_INTERNAL_REPEAT1(__VA_ARGS__))))
#define COMPLEX_INTERNAL_REPEAT3(...) COMPLEX_INTERNAL_REPEAT2(COMPLEX_INTERNAL_REPEAT2(COMPLEX_INTERNAL_REPEAT2(COMPLEX_INTERNAL_REPEAT2(__VA_ARGS__))))
#define COMPLEX_REPEAT(...) COMPLEX_INTERNAL_REPEAT3(COMPLEX_INTERNAL_REPEAT3(COMPLEX_INTERNAL_REPEAT3(COMPLEX_INTERNAL_REPEAT3(__VA_ARGS__))))
